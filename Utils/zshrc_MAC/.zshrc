...
#Decomment only if you want default dark-mode on your MAC after login, and after you added the dark.swift file in the "${HOME}" directory.
#if [ "${PWD}" = "${HOME}" ]; then
#	swift dark.swift
#	des
#	c
...
#Decomment if you want Deskotop as default start-up location directory when you open your iterm.
#des
